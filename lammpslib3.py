...
"""
    ...
    def set_additional_command(self, cmd):
        if self.parameters.amendments is None:
            self.parameters.amendments = []
        self.parameters.amendments.append(cmd)
        
    def reset_additional_command(self, cmd=None):
        self.parameters.amendments = []
        if cmd is not None:
            self.parameters.amendments.append(cmd)
